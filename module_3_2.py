...
def send_email(message, recipient, sender='university.help@gmail.com'):
    correct_suffix = (".com", ".ru", ".net")
    if not ('@' in recipient and '@' in sender and
            recipient.endswith(correct_suffix) and sender.endswith(correct_suffix)):
        string_to_print = f'Невозможно отправить письмо с адреса {sender} на адрес {recipient}'
    elif recipient == sender:
        string_to_print = 'Нельзя отправить письмо самому себе!'
    elif sender == 'university.help@gmail.com':
        string_to_print = f'Письмо успешно отправлено с адреса {sender} на адрес {recipient}'
    else:
        string_to_print = f'НЕСТАНДАРТНЫЙ ОТПРАВИТЕЛЬ! Письмо отправлено с адреса {sender} на адрес {recipient}'
